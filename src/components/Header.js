...
const Header = () => {
  return (
    <div className="nav-bar">
      ...
      <div className="nav-bar__user-control">
        <div>
          ...
          <p style={{ fontWeight: 400, color: "#616173", fontSize: "13px" }}>
            {userInfo.company}, {userInfo.position}
          </p>
          </div>
          <div className="nav-bar__logout"><img src={logout} alt="#" className="nav-bar__logout-icon" /></div>
